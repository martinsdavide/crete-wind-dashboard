...
export const MaremmaSpots: RegionSpotConfig[] = [
  {
    ...
    localCorrection: {
      ...
      diurnalThermalBoost: {
        ...
        maxBoost: 0.20,
        maxMultiplicativeBoost: 0.20,
        maxAdditiveBoostKt: 3.5,
        minimumConfidenceForCorrection: 0.35,
        monthFactors: {
          5: 0.6,
          6: 0.9,
          7: 1.0,
  ...
  },
  {
    ...
    latitude: 42.718,
    longitude: 10.985,
    description: "Central Maremma Coast • Wide sandy beach with side-on NW Maestrale thermal breeze and bump & jump.",
    sweetSpotSummary: "Optimal in 16–26 kt NW/WNW/NNW flows with clean side-on thermal breeze; SW is direct onshore with heavy shorebreak.",
    idealDirections: ["NW", "WNW", "NNW", "W"],
    idealDirectionDegrees: [270, 345],
    minPlaningWind: 12,
    idealWindMin: 16,
    idealWindMax: 26,
    ...
    styleRules: {
      ...
      favoredDirections: ["NW", "WNW", "NNW", "W"],
    },
    qualityCurve: [
      { wind: 0, score: 0 },
      { wind: 11, score: 15 },
